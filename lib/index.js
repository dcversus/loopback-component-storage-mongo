...
router.post('/:fileableType/:fileableId/file', (req, res, next) => {
  app.context = {};
  app.context.req = req;
  app.context.res = res;
  next()
...
var MongoStorage = (function() {
  ...
  MongoStorage.prototype.findOrCreate = function(query, data, options, callback) {
    ...
    this.create(app.context.req, app.context.res, function(err, file) {
  ...
  MongoStorage.prototype.create = function(req, res, callback) {
    var self = this;
