...
var RelationMixin = require('loopback-connector-remote/lib/relations');
...
function MongoStorage(settings) {
  ...
  jutil.mixin(MongoStorage.prototype, RelationMixin);
  jutil.mixin(MongoStorage.prototype, InclusionMixin);
}

MongoStorage.prototype.modelName = 'storage';
MongoStorage.prototype.relations = [];
MongoStorage.prototype.prototype = MongoStorage.prototype;
MongoStorage.prototype.resolve = function(Model) {}
